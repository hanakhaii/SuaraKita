...
<head>
    ...
    <link rel="stylesheet" href="../css/dashboardser.css">
...
<body>
    ...
    <section class="sec1">
        <div class="inline1">
            <h1>Halo Selamat Datang <br> <span>NamaUser!</span></h1>

            <p>Selamat datang di SuaraKita! Platform pemungutan suara yang transparan, adil, dan mudah digunakan. Mari
                berpartisipasi dalam pemilihan ini untuk menentukan pemimpin terbaik. Suara Anda adalah masa depan kita!
            </p>
        </div>
    </section>
    ...
    <section id="kandidat" class="sec2">
        ...
        <div class="inline2">
            <div class="kandidat">
                ...
                <button onclick="window.location.href='tampilan_kandidat.html'">Lihat</button>
            </div>
            <div class="kandidat">
                <h1 class="judul">02</h1>
                <img src="../gambal/hamonue.jpg" alt="">
                ...
                <button onclick="window.location.href='tampilan_kandidat2.html'">Lihat</button>

            </div>
            <div class="kandidat">
                <h1 class="judul">03</h1>
                <img src="../gambal/ron.jpg" alt="">
                ...
                <button onclick="window.location.href='tampilan_kandidat3.html'">Lihat</button>
    ...
    <section id="vote" class="sec4">
        <div class="inline4">
            ...
            <button class="btn-vote" onclick="window.location.href='voting.html'">Vote Now!</button>
        </div>
    </section>
        ...
        <div class="inline5">
            <div class="count">
                <p>Pantau hasil sementara pemungutan suara secara real-time dengan fitur Quick Count. Data diperbarui
                    ...
                    pemilihan ini!</p>
                <button class="btn-detail" onclick="window.location.href='  b     quickcount.html'">Lihat Detail</button>
            </div>
            <div>
                <img src="../gambal/bar.png" alt="" srcset="">
            </div>
        </div>
    </section>
