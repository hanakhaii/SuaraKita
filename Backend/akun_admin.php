...
<body>
    <div class="scroll-area">
        ...
        <div class="container">
            ...
            <main class="main_dashboard">
                ...
                <div id="btnLogout" class="settings">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path fill="currentColor"
                ...
                <div id="btnHapusAkun" class="settings" style="color: red;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path fill="#f00" d="M7 21q-.825 0-1.412-.587T5 19V6H4V4h5V3h6v1h5v2h-1v13q0 .825-.587 1.413T17 21zm2-4h2V8H9zm4 0h2V8h-2z" />
                    </svg>
                    Hapus Akun
                </div>
            </main>
    ...
    <script>
                    ...
                    fetch('Backend/logout.php', {
                        ...
                        .then(() => {
                            Swal.fire({
                                ...
                                window.location.href = 'home.php'; // arahkan ke home
                            });
                        });
                }
            });
        ...
        // untuk pop-up hapus akun
        document.getElementById('btnHapusAkun').addEventListener('click', function() {
            Swal.fire({
                title: 'Hapus akun?',
                text: 'Akun dan data Anda akan dihapus secara permanen.',
                icon: 'warning',
                showCancelButton: true,
                ...
                if (result.isConfirmed) {
                    fetch('Backend/delete_account.php', {
                        ...
                        .catch(error => {
                            Swal.fire('Oops!', 'Terjadi kesalahan saat menghapus akun.', 'error');
                        });
                }
            });
        });
